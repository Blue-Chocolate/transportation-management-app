...
class ClientPanelProvider extends PanelProvider
{
    ...
    {
        return $panel
            ->id('client')                     // Panel identifier
            ->path('client')                   // URL prefix, e.g. /client
            ->authGuard('client')             // Use the 'client' guard (from config/auth.php):contentReference[oaicite:2]{index=2}
